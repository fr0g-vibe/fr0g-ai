...
tmux send-keys -t $SESSION_NAME:0 "$AIDER_CMD --message-file .aider-prompts/project-lead.md README.md docker-compose.yml Makefile TODO.md .env.example" C-m
...
tmux send-keys -t $SESSION_NAME:1 "$AIDER_CMD --message-file .aider-prompts/aip-agent.md TODO.md" C-m
...
tmux send-keys -t $SESSION_NAME:2 "$AIDER_CMD --message-file .aider-prompts/bridge-agent.md TODO.md" C-m
...
tmux send-keys -t $SESSION_NAME:3 "$AIDER_CMD --message-file .aider-prompts/mcp-agent.md TODO.md" C-m
...
tmux send-keys -t $SESSION_NAME:4 "$AIDER_CMD --message-file .aider-prompts/io-agent.md TODO.md" C-m
...
tmux send-keys -t $SESSION_NAME:5 "$AIDER_CMD --message-file .aider-prompts/config-agent.md .env.example .env pkg/config/config.go pkg/config/validation.go pkg/config/loader.go pkg/config/examples_test.go pkg/config/README.md" C-m
...
tmux send-keys -t $SESSION_NAME:6 "$AIDER_CMD --message-file .aider-prompts/devops-agent.md docker-compose.yml Makefile .env.example" C-m
...
tmux send-keys -t $SESSION_NAME:7 "$AIDER_CMD --message-file .aider-prompts/registry-agent.md TODO.md" C-m
