...
AIP_CMD=$(create_aider_cmd ".prompts/aip-agent.md" "--file TODO.md --file fr0g-ai-aip/TODO.md")
...
BRIDGE_CMD=$(create_aider_cmd ".prompts/bridge-agent.md" "--file TODO.md --file fr0g-ai-bridge/TODO.md")
...
MCP_CMD=$(create_aider_cmd ".prompts/mcp-agent.md" "--file TODO.md --file fr0g-ai-master-control/TODO.md")
...
IO_CMD=$(create_aider_cmd ".prompts/io-agent.md" "--file TODO.md --file fr0g-ai-io/TODO.md")
...
REGISTRY_CMD=$(create_aider_cmd ".prompts/registry-agent.md" "--file TODO.md --file fr0g-ai-registry/TODO.md")
